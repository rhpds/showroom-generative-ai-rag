...
image::chat-without-rag.png[Chatbot response without RAG showing generic answer,align="center",width=700,title="Chatbot Without RAG - Generic Response"]
...
image::chat-with-rag.png[Chatbot response with RAG showing accurate answer from documentation,align="center",width=700,title="Chatbot With RAG - Accurate Response"]
...
image::llm-rag-architecture.png[RAG architecture diagram showing indexing and retrieval,align="center",width=600,title="RAG Architecture Overview"]
...
image::load-split-embed-store.png[Document indexing flow,align="center",width=700,title="Document Indexing: Load → Split → Embed → Store"]
...
image::retrieve-llm.png[Retrieval and LLM generation flow,align="center",width=700,title="Runtime: Retrieve → Generate Response"]
...
image::business-benefits-llm-rag.png[Business benefits infographic,align="center",width=800,title="Business Benefits of LLM with RAG"]

== LLM + RAG Summary

image::llm-rag-summary-diagram.png[Summary diagram of LLM and RAG integration,align="center",width=800,title="LLM + RAG Solution Architecture"]

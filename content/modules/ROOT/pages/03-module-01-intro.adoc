...
image::chat-without-rag.png[Generic chatbot response without RAG,align="center",width=700,title="Without RAG: Generic Response"]
...
image::llm-rag-architecture.png[RAG architecture overview,align="center",width=600,title="RAG Architecture"]
...
image::load-split-embed-store.png[Document indexing process,align="center",width=700,title="Indexing: Load → Split → Embed → Store"]

image::retrieve-llm.png[Retrieval and generation flow,align="center",width=700,title="Runtime: Retrieve Context → Generate Response"]
...
image::business-benefits-llm-rag.png[Business benefits of LLM with RAG,align="center",width=800,title="Measurable Business Benefits"]
...
image::llm-rag-summary-diagram.png[LLM and RAG integration summary,align="center",width=800,title="Solution Architecture Summary"]

...
image::demo/ocp-login.png[OpenShift console login,align="center",width=700,title="OpenShift Console Login"]
...
image::demo/ic-shared-rag-llm.png[RAG project pods status,align="center",width=800,title="RAG Project - All Pods Running"]
...
image::demo/ds-project.png[Data science project selection,align="center",width=700,title="OpenShift AI - Data Science Projects"]
...
image::demo/shared-rag-llm-project.png[RAG project details,align="center",width=800,title="RAG Project Components"]
...
image::demo/llm-workbench.png[Workbench creation,align="center",width=700,title="Creating Jupyter Workbench"]
...
image::demo/import-pipeline-1.png[Import pipeline step 1,align="center",width=700,title="Import Pipeline Definition"]

image::demo/import-pipeline-2.png[Import pipeline upload,align="center",width=700,title="Upload Pipeline YAML"]
...
image::demo/dag.png[Pipeline DAG visualization,align="center",width=800,title="Pipeline DAG - 4 Tasks"]
...
image::demo/create-run.png[Create pipeline run,align="center",width=700,title="Create Pipeline Run"]

image::demo/create-run-2.png[Pipeline run parameters,align="center",width=700,title="Configure Run Parameters"]
...
image::demo/task-run-1.png[Pipeline tasks overview,align="center",width=800,title="Pipeline Tasks - 4 Steps"]
...
image::demo/langchain-task-view.png[Task execution in OpenShift AI,align="center",width=800,title="OpenShift AI - Task Execution"]
...
image::demo/data-ingestion-response-check.png[Pipeline run in OpenShift console,align="center",width=800,title="OpenShift Console - Pipeline Execution"]
...
image::demo/successful-run-completion-dag.png[Completed pipeline DAG,align="center",width=800,title="Successful Pipeline Completion"]
...
image::demo/open-test-llm-wkbench.png[Open workbench,align="center",width=700,title="Launch Jupyter Workbench"]

image::demo/authorize-test-llm.png[Authorize workbench access,align="center",width=700,title="Authorize Jupyter Access"]
...
image::demo/clone-repo.png[Clone Git repository,align="center",width=700,title="Clone Repository in Jupyter"]

image::demo/update-branch.png[Switch to branch,align="center",width=700,title="Switch to update-token-v1 Branch"]
...
image::demo/review-ds-pipeline-ui.png[Review pipeline configuration,align="center",width=700,title="Data Science Pipeline Configuration"]

image::demo/minio-route.png[Get MinIO route,align="center",width=700,title="MinIO S3 Route"]

image::demo/minio-route-update.png[Update pipeline endpoint,align="center",width=700,title="Update Pipeline Endpoint"]

image::demo/dsp-endpoint-check.png[Verify endpoint,align="center",width=700,title="Verify Cloud Object Storage Endpoint"]
...
image::demo/select-pipeline.png[Select pipeline file,align="center",width=700,title="Open Pipeline in Elyra"]
...
image::demo/task-1-update.png[Pipeline task details,align="center",width=700,title="Task 1 - Data Ingestion Code"]
...
image::demo/run-pipeline.png[Submit pipeline run,align="center",width=700,title="Submit Pipeline from Elyra"]
...
image::demo/job-submission.png[Pipeline submission confirmation,align="center",width=700,title="Pipeline Submitted Successfully"]

image::demo/check-data-pipeline-elyra.png[Pipeline in dashboard,align="center",width=700,title="Pipeline Execution in Dashboard"]

image::demo/data-ingestion-response-check-graph.png[Pipeline graph view,align="center",width=700,title="Pipeline Execution Graph"]

image::demo/run-check-main-ui.png[Pipeline run details,align="center",width=700,title="Pipeline Run Status"]
...
image::demo/drag-task-elyra.png[Drag new task,align="center",width=700,title="Drag Python File to Add Task"]

image::demo/drag-task-elyra-step1.png[Connect tasks,align="center",width=700,title="Connect Tasks in Pipeline"]
...
image::demo/troubleshooting-rag.png[Expected pods in RAG project,align="center",width=800,title="Troubleshooting - Expected Pods"]

image::demo/check-argo-1.png[Argo CD application health,align="center",width=700,title="Argo CD - Verify Application Health"]

image::demo/check-argo-2.png[Argo CD sync with prune,align="center",width=700,title="Argo CD - Sync with Prune"]
